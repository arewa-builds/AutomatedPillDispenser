// ============================================================================
// v2 PART G — base cover / electronics floor
//
// Closes the bay under the fixed plate and gives the Nano 33 BLE, TP4056 and
// LiPo a flat mounting floor. Three M3 screws pull it up into the posts moulded
// into the drum wall.
// ============================================================================
...
translate([0, 0, -base_z]) base_cover_v2();

echo(str("G2 base cover: dia ", h_od, " x ", base_t, " mm"));
